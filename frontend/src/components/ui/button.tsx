...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-transport",
        ...
        action: "action-gradient text-white hover:bg-action-secondary shadow-action font-semibold",
        transport: "transport-gradient text-white hover:opacity-90 shadow-transport-elevated",
        ...
        "outline-action": "border-2 border-action-primary text-action-primary bg-transparent hover:bg-action-light",
      },
      size: {
